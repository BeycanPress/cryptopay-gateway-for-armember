...
1. Upload the entire `/arm-cryptopay-gateway` directory to the `/wp-content/plugins/` directory.
2. Activate ARMember - CryptoPay Gateway through the 'Plugins' menu in WordPress.
3. Enjoy.
